	...
	<div class="container">
		<div class="jumbotron" style="background-color: #BCF5A9">
			<div class="container">
				...
				<br> <a class="btn btn-primary btn-pull" href="detail.jsp"
					role="button">자세히 알아보기</a>
			</div>
		</div>
	</div>
