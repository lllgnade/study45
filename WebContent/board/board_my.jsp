...
<body>
	...
	<nav class="navbar navbar-default" style="background-color: #CEF6F5">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="board_tip.jsp" style="font-size: 1.0em">팁
				...
				href="board_my.jsp"
				style="font-size: 1.0em; background-color: #BEE6E5; align: right;">내
				글 보기</a>
		</div>
		<%-- 우측 상단 메뉴 --%>
	...
	<div class="container">
		...
		<center>
			...
			<c:if test="${pageNum!=1}">
				...
				<c:choose>
					...
					<c:when test="${ifSearching}">
						...
						<a
							href="board_my.jsp?pageNum=<%=pageNum - 1%>&object=${param.object}&query=${param.query}"
			...
			<c:if
				test="<%=boardDAO.showBoard(boardFilter, pageNum + 1, 10).size() != 0%>">
