...
<body>
	...
	<nav class="navbar navbar-default" style="background-color: #CEF6F5">
		<div class="navbar-header">
			...
			<c:choose>
				<c:when test="${fn:contains(location, 'scrap')}">
					...
					<a class="navbar-brand" href="board_scrap.jsp"
						style="font-size: 1.0em; background-color: #BEE6E5;">스크랩</a>
				</c:when>
				<c:otherwise>
					<a class="navbar-brand" href="board_free.jsp"
						style="font-size: 1.0em;">자유게시판</a>
					...
					<a class="navbar-brand" href="board_question.jsp"
						style="font-size: 1.0em;">질문게시판</a>
					<a class="navbar-brand" href="board_my.jsp"
						style="font-size: 1.0em; background-color: #BEE6E5;">내 글 보기</a>
				</c:otherwise>
			</c:choose>
		</div>
		<%-- 우측 상단 메뉴 --%>
		...
		.replaceAll("\n", "<br>")%></td>
			...
			<c:if test="userID!=null && userID.equals(boardInfo.getUserID())">
				...
				<a onclick="return confirm('정말로 삭제하시겠습니까?')"
					href="delete_process.jsp?boardNo=${boardNo}&boardType=${boardType}&location=${location}"
