...
<body>
	...
	<nav class="navbar navbar-default" style="background-color: #CEF6F5">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="board_tip.jsp" style="font-size: 1.0em">팁
				...
				style="font-size: 1.0em">질문게시판</a> <a class="navbar-brand"
				href="board_scrap.jsp"
				style="font-size: 1.0em; background-color: #BEE6E5; align: right;">스크랩</a>
		</div>
		<%-- 우측 상단 메뉴 --%>
	...
	<div class="container">
			...
			<thead>
				<tr>
					<th scope="col" class="text-center"
						style="background-color: #BCF5A9">게시판</th>
					<th scope="col" class="text-center"
		...
		<center>
			...
			<c:if test="${pageNum!=1}">
				...
				<c:choose>
					...
					<c:when test="${ifSearching}">
						...
						<a
							href="board_scrap.jsp?pageNum=<%=pageNum - 1%>&object=${param.object}&query=${param.query}"
			...
			<c:if
				test="<%=boardDAO.myScrapBoard(boardFilter, userID, pageNum + 1, 10).size() != 0%>">
