...
<body>
	...
	<table class="table table-striped" style="text-align : center; border:1px solid #dddddd">
		<thead>
		<tr>
			<th colspan="2" scope="col" class="text-center" style="background-color: #eeeeee">글 수정</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td><input type="text" class="form-control" placeholder="글 제목" name="title" maxlength="100" value="<%= boardInfo.getTitle() %>"></td>
		</tr>
		<tr>	
			<td><textarea class="form-control" placeholder="글 내용" name="contents" maxlength="4096" style="height:350px;resize: vertical;"><%= boardInfo.getContents() %></textarea></td>
		</tr>
	</tbody>
	</table>
