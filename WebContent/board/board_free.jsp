	...
	<nav class="navbar navbar-default" style="background-color: #CEF6F5">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="../main.jsp">Study for 4.5</a> <a
				...
				style="font-size: 1.0em; background-color: #BEE6E5;">자유게시판</a> <a
	...
	<div class="container">
		...
		<%
			if (pageNum != 1) {
				...
				if(ifSearching){
		%>
		<a href="board_free.jsp?pageNum=<%=pageNum - 1%>&object=<%=object%>&query=<%=query%>"
		...
		<a href="write.jsp?boardType=free" class="btn btn-primary pull-left">글쓰기</a>
		
		<form
		class="form-inline pull-right" method="post" action="board_free.jsp">
