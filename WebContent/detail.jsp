...
<body>
	...
	<div class="container">
		<div class="text_container" style="position:relative;">
			<img src="image/chalkboard-152414_1280.png" width="400" height="400" border="0">
			<div style="left:90px; width:1000px; bottom: 140px; font-size: 1.4em; font-weight: bold; position: absolute;">
				<h2 style="color:#BCF5A9;">Study for 4.5에 오신 것을 환영합니다.</h2>
				<br>
				<h4 style="color:#BCF5A9;">이 곳은 다른 유저와 공부 팁을 공유해서 더 나은 공부 팁을 찾아 가는 곳입니다.</h4>
		...
		<table class="table table-hover">
			<tr>
				...
				<td>
					...
					<h5>자기가 알고있는 답을 다른 유저에게 공유할 수도 있어요</h5>
					<br>
					<br>
